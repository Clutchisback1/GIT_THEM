...
proxychains git clone https://github.com/archerysec/archerysec.git
proxychains git clone https://github.com/maurosoria/dirsearch.git
proxychains git clone https://github.com/codingo/Reconnoitre.git
proxychains git clone https://github.com/RenwaX23/XSS-Payloads.git
proxychains git clone https://github.com/caffix/amass.git
proxychains git clone https://github.com/cyberheartmi9/PayloadsAllTheThings.git
proxychains git clone https://github.com/TheSecondSun/Bashark.git
proxychains git clone https://github.com/s0md3v/AwesomeXSS.git
proxychains git clone https://github.com/PapirusDevelopmentTeam/papirus-icon-theme.git
proxychains git clone https://github.com/s0md3v/Photon.git
proxychains git clone https://github.com/LostRabbitLabs/AnomalousCookie.git
proxychains git clone https://github.com/stealth/sshttp.git
proxychains git clone https://github.com/mps-youtube/mps-youtube.git
proxychains git clone https://github.com/joaomatosf/jexboss.git
proxychains git clone https://github.com/zerosum0x0/koadic.git
